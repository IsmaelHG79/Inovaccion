...
#!/bin/bash
#------------------------------------------------------------------------------------------------------------#
#	Nombre:		rci_run_flow_u2000Gpon.sh                                          		 		 	 		 #
#	Versión:	1.0.0                                          			 		                             #
#	Objetivo: 	Shell encargado de ejecutar el flujo de ingestion de la fuente U2000 GPON					 #
#	Autor:		ejesus				                                                                         #
...
. $path_log4jadc/log4j_attdlkrci.sh 2 'rci_run_flow_u2000Gpon' "$environment" "$path_rci" "$group_exec" "$table_execute"
create_dir_logs
