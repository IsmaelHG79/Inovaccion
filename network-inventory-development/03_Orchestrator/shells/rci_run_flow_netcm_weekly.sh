...
#!/bin/bash
#------------------------------------------------------------------------------------------------------------#
#	Nombre:		rci_run_flow_netcm_weekly.sh                                          		 		 	 	 #
#	Versión:	1.0.0                                          			 		                             #
#	Objetivo: 	Shell encargado de ejecutar el flujo de ingestion de la fuente NetCM periodicidad semanal 	 #
#	Autor:		ejesus				                                                                         #
...
export ids_flows="102,103,106,108"
