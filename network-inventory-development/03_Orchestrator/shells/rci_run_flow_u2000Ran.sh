...
#!/bin/bash
#------------------------------------------------------------------------------------------------------------#
#	Nombre:		rci_run_flow_u2000Ran.sh                                          		 		 	 		 #
#	Versión:	1.0.0                                          			 		                             #
#	Objetivo: 	Shell encargado de ejecutar el flujo de ingestion de la fuente U2000 RAN					 #
#	Autor:		ejesus				                                                                         #
...
export ids_flows="132,133,134,135,136,137,138"
