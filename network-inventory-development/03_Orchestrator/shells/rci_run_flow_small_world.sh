...
#!/bin/bash
#------------------------------------------------------------------------------------------------------------#
#	Nombre:		rci_run_flow_small_world.sh                                          		 		 	 	 #
#	Versión:	1.0.0                                          			 		                             #
#	Objetivo: 	Shell encargado de ejecutar el flujo de ingestion de la fuente Smallworld					 #
#	Autor:		ejesus				                                                                         #
...
export ids_flows="111,112,113,114,115,116,117,118,119,120,121,122,123,124,125"
...
home(){
	...
	export ids_flows="126,127,128,129,130,131"
	export pending_flows=""
	execute_flow
